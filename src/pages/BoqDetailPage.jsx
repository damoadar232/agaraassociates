...
export function BoqDetailPage() {
    ...
    return (<div className="space-y-6 animate-in fade-in duration-500">
      <Link to={clientId ? `/boq?client=${clientId}` : "/boq"} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              {boq.projectType && (<Badge variant="outline" className="mt-2 capitalize">
                  {boq.projectType}
                </Badge>)}
            </div>
          ...
          <Card>
            <CardContent className="p-0 overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {lineEstimates.map(({ item, total, gstAmount, labourAmount, marginAmount }) => (<tr key={item.id} className="border-b hover:bg-muted/30">
        ...
        <Card className="lg:w-80 h-fit sticky top-24 card-hover">
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            {boq.takeoffSnapshot && (<p className="text-xs text-muted-foreground pt-2 border-t">
