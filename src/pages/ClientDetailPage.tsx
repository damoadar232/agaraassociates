...
export function ClientDetailPage() { const { id } = useParams() as { id: string };
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {projects.length === 0 ? (
                ...
                <Link key={p.id} to={`/projects/${p.id}`} className="flex items-center justify-between p-3 rounded-xl border hover:bg-muted/30">
                  <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {quotations.length === 0 ? (
                ...
                <Link key={q.id} to={`/quotations/${q.id}?client=${id}`} className="flex items-center justify-between p-3 rounded-xl border hover:bg-muted/30">
                  <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {communications.length === 0 ? (
                <p className="text-sm text-muted-foreground">No communication log.</p>
