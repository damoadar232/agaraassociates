...
export function Sidebar() {
    ...
    return (<aside className="hidden lg:flex w-[240px] flex-col glass-subtle border-r border-border/40 h-screen sticky top-0">
        ...
        <nav className="px-3 space-y-5">
          {groups.map((group) => (<div key={group}>
              ...
              <div className="space-y-0.5">
                ...
                return (<Link key={item.href} to={item.href} className={cn("flex items-center gap-2.5 rounded-2xl px-3 py-2 text-[13px] font-medium transition-all duration-200", isActive
                        ? "glass-pill-active"
