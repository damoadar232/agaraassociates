...
export function DashboardHero({ userName, studio, userRole = CURRENT_USER.role, weather, onTrackPercent = 87, }) {
    ...
    return (<div className="flex flex-col gap-2.5 lg:h-full lg:min-h-0">
      <GlassCard className="px-3 py-2.5 shrink-0">
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-2xl bg-surface/80 border border-border/60 shrink-0">
            <div className={cn("flex h-7 w-7 items-center justify-center rounded-lg", weather.icon === "sunny"
      ...
      <GlassCard className="relative overflow-hidden p-0 flex-1 min-h-[220px] sm:min-h-[260px] lg:min-h-0 lg:flex lg:flex-col">
        <div className="relative flex-1 min-h-[220px] sm:min-h-[260px] lg:min-h-0">
          <img src={profileImage} alt={userName} className="absolute inset-0 h-full w-full object-cover object-[center_15%]"/>
