...
export function DashboardLayout() {
  ...
  return (
    <div className={cn("flex min-h-screen", isDashboard ? "dashboard-bg" : "bg-background")}>
      <Sidebar />
      ...
      <Link
        to="/projects/new"
        className="fixed bottom-6 right-6 lg:hidden flex h-14 w-14 items-center justify-center rounded-full bg-primary border border-border/60 text-foreground shadow-glass hover:scale-105 transition-all z-40"
      >
