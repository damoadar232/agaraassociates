import { ServiceType, ConstructionType, FoundationType, StructuralSystem, ConstructionMethod } from "@/types";
import {
  Building2,
  Sofa,
  Key,
...
export const CONSTRUCTION_METHOD_OPTIONS: { value: ConstructionMethod; label: string }[] = [
...
export const SERVICE_TYPE_LABELS: Record<ServiceType, string> = Object.fromEntries(
